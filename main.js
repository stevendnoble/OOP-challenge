...
$(document).ready(function() {
	...
	function Flower(name, color, petals, petalSize, stemLength, carnivorous, smellsPretty, parent1, parent2, imageURL) {
	  ...
	  this.describe = function() {
	    var str = ("The "+this.name+" is a "+this.color +" flower with "+this.petals+".  ");
	...
	// Array of flowers
	var flowers = [
	  new Flower('delphinium', 'purple', 8, 2, 3, false, true),
	  new Flower('tulip', 'violet', 6, 2, 6, false, true),
	  new Flower('rose', 'red', 22, 3, 12, false, true),
	  new Flower('primrose', 'yellow', 4, 3, 5, false, false),
	  new Flower('venus flytrap', 'green-red', 2, 3, 4, true, false)
	];
	...
	// var flowersHTML = template(flowers.slice(i, i+4));
	$('#results').append(template(flowers.slice(i, i+4)));
});
